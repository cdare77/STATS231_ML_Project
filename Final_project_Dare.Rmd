...
SSD$NVDA_EMA_cl_1W <- exponential_moving_average(SSD$NVDA_Close, 5)
SSD$TSM_EMA_cl_1W <- exponential_moving_average(SSD$TSM_Close, 5)
SSD$NXPI_EMA_cl_1W <- exponential_moving_average(SSD$NXPI_Close, 5)
SSD$QCOM_EMA_cl_1W <- exponential_moving_average(SSD$QCOM_Close, 5)
SSD$MPWR_EMA_cl_1W <- exponential_moving_average(SSD$MPWR_Close, 5)
SSD$ON_EMA_cl_1W <- exponential_moving_average(SSD$ON_Close, 5)
SSD$AMD_EMA_cl_1W <- exponential_moving_average(SSD$AMD_Close, 5)
SSD$INTC_EMA_cl_1W <- exponential_moving_average(SSD$INTC_Close, 5)
SSD$AVGO_EMA_cl_1W <- exponential_moving_average(SSD$AVGO_Close, 5)
SSD$ASML_EMA_cl_1W <- exponential_moving_average(SSD$ASML_Close, 5)
SSD$AMAT_EMA_cl_1W <- exponential_moving_average(SSD$AMAT_Close, 5)
SSD$TXN_EMA_cl_1W <- exponential_moving_average(SSD$TXN_Close, 5)


SSD$NVDA_EMA_cl_2W <- exponential_moving_average(SSD$NVDA_Close, 10)
SSD$TSM_EMA_cl_2W <- exponential_moving_average(SSD$TSM_Close, 10)
SSD$NXPI_EMA_cl_2W <- exponential_moving_average(SSD$NXPI_Close, 10)
SSD$QCOM_EMA_cl_2W <- exponential_moving_average(SSD$QCOM_Close, 10)
SSD$MPWR_EMA_cl_2W <- exponential_moving_average(SSD$MPWR_Close, 10)
SSD$ON_EMA_cl_2W <- exponential_moving_average(SSD$ON_Close, 10)
SSD$AMD_EMA_cl_2W <- exponential_moving_average(SSD$AMD_Close, 10)
SSD$INTC_EMA_cl_2W <- exponential_moving_average(SSD$INTC_Close, 10)
SSD$AVGO_EMA_cl_2W <- exponential_moving_average(SSD$AVGO_Close, 10)
SSD$ASML_EMA_cl_2W <- exponential_moving_average(SSD$ASML_Close, 10)
SSD$AMAT_EMA_cl_2W <- exponential_moving_average(SSD$AMAT_Close, 10)
SSD$TXN_EMA_cl_2W <- exponential_moving_average(SSD$TXN_Close, 10)

SSD$NVDA_EMA_cl_1M <- exponential_moving_average(SSD$NVDA_Close, 20)
SSD$TSM_EMA_cl_1M <- exponential_moving_average(SSD$TSM_Close, 20)
SSD$NXPI_EMA_cl_1M <- exponential_moving_average(SSD$NXPI_Close, 20)
SSD$QCOM_EMA_cl_1M <- exponential_moving_average(SSD$QCOM_Close, 20)
SSD$MPWR_EMA_cl_1M <- exponential_moving_average(SSD$MPWR_Close, 20)
SSD$ON_EMA_cl_1M <- exponential_moving_average(SSD$ON_Close, 20)
SSD$AMD_EMA_cl_1M <- exponential_moving_average(SSD$AMD_Close, 20)
SSD$INTC_EMA_cl_1M <- exponential_moving_average(SSD$INTC_Close, 20)
SSD$AVGO_EMA_cl_1M <- exponential_moving_average(SSD$AVGO_Close, 20)
SSD$ASML_EMA_cl_1M <- exponential_moving_average(SSD$ASML_Close, 20)
SSD$AMAT_EMA_cl_1M <- exponential_moving_average(SSD$AMAT_Close, 20)
SSD$TXN_EMA_cl_1M <- exponential_moving_average(SSD$TXN_Close, 20)

SSD$NVDA_EMA_cl_2M <- exponential_moving_average(SSD$NVDA_Close, 40)
SSD$TSM_EMA_cl_2M <- exponential_moving_average(SSD$TSM_Close, 40)
SSD$NXPI_EMA_cl_2M <- exponential_moving_average(SSD$NXPI_Close, 40)
SSD$QCOM_EMA_cl_2M <- exponential_moving_average(SSD$QCOM_Close, 40)
SSD$MPWR_EMA_cl_2M <- exponential_moving_average(SSD$MPWR_Close, 40)
SSD$ON_EMA_cl_2M <- exponential_moving_average(SSD$ON_Close, 40)
SSD$AMD_EMA_cl_2M <- exponential_moving_average(SSD$AMD_Close, 40)
SSD$INTC_EMA_cl_2M <- exponential_moving_average(SSD$INTC_Close, 40)
SSD$AVGO_EMA_cl_2M <- exponential_moving_average(SSD$AVGO_Close, 40)
SSD$ASML_EMA_cl_2M <- exponential_moving_average(SSD$ASML_Close, 40)
SSD$AMAT_EMA_cl_2M <- exponential_moving_average(SSD$AMAT_Close, 40)
SSD$TXN_EMA_cl_2M <- exponential_moving_average(SSD$TXN_Close, 40)

SSD %>% select( TXN_Close, TXN_SMA_cl_1W, TXN_EMA_cl_1W) %>% head(40)
```
