...
While there are multiple financial metrics which account for previous stock prices, this analysis will only look at two basic measurements: the simple moving average and the simple moving standard deviation (where n is some integer-valued hyper-parameter). Although there are subtle differences between the opening price and the closing price of a stock, the larger the window is (i.e. the number of days we are averaging over) the less the distinction should matter in terms of which variable to average; for consistency, we will simply base our new metrics on the closing costs of each stock.
...
Portfolio$SMA_cl_1W <- simple_moving_average(Portfolio$Close, 5)
Portfolio$SMA_cl_2W <- simple_moving_average(Portfolio$Close, 10)
Portfolio$SMA_cl_1M <- simple_moving_average(Portfolio$Close, 20)
Portfolio$SMA_cl_2M <- simple_moving_average(Portfolio$Close, 40)

ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMA_cl_1W, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 1-Week Average of Closing Price") +
  scale_y_continuous(limits=c(1900, 5300), labels = label_comma()) +
  theme_dark()

ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMA_cl_2W, color = 'red')) +
  ylab('USD') + 
...
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMA_cl_1M, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 1-Month Average of Closing Price") +
  scale_y_continuous(limits=c(1900, 5300), labels = label_comma()) +
  theme_dark()

ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMA_cl_2M, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 2-Month Average of Closing Price") +
  scale_y_continuous(limits=c(1900, 5300), labels = label_comma()) +
  theme_dark()
```
...
Portfolio$SMSD_cl_1W <- simple_moving_deviation(Portfolio$Close, 5)
Portfolio$SMSD_cl_2W <- simple_moving_deviation(Portfolio$Close, 10)
Portfolio$SMSD_cl_1M <- simple_moving_deviation(Portfolio$Close, 20)
Portfolio$SMSD_cl_2M <- simple_moving_deviation(Portfolio$Close, 40)

ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMSD_cl_1W, color = 'red')) +
  ylab('USD') + 
  scale_y_continuous(limits=c(0, 520), labels = label_comma()) +
  ggtitle("Portfolio: 1-Week Standard Deviation of Closing Price") +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMSD_cl_2W, color = 'red')) +
  ylab('USD') + 
  scale_y_continuous(limits=c(0, 520), labels = label_comma()) +
  ggtitle("Portfolio: 2-Week Standard Deviation of Closing Price") +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMSD_cl_1M, color = 'red')) +
  ylab('USD') + 
  scale_y_continuous(limits=c(0, 520), labels = label_comma()) +
  ggtitle("Portfolio: 1-Month Standard Deviation of Closing Price") +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMSD_cl_2M, color = 'red')) +
  ylab('USD') + 
  scale_y_continuous(limits=c(0, 520), labels = label_comma()) +
  ggtitle("Portfolio: 2-Month Standard Deviation of Closing Price") +
  theme_dark()
```

### Simple Moving Average of Return
...
Portfolio$SMA_ret_1W <- simple_moving_average(Portfolio$Return, 5)
Portfolio$SMA_ret_2W <- simple_moving_average(Portfolio$Return, 10)
Portfolio$SMA_ret_1M <- simple_moving_average(Portfolio$Return, 20)
Portfolio$SMA_ret_2M <- simple_moving_average(Portfolio$Return, 40)

ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMA_ret_1W, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 1-Week Average Return") +
  scale_y_continuous(limits=c(-80, 80), labels = label_comma()) +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMA_ret_2W, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 2-Week Average Return") +
  scale_y_continuous(limits=c(-80, 80), labels = label_comma()) +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMA_ret_1M, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 1-Month Average Return") +
  scale_y_continuous(limits=c(-80, 80), labels = label_comma()) +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMA_ret_2M, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 2-Month Average Return") +
  scale_y_continuous(limits=c(-80, 80), labels = label_comma()) +
  theme_dark()
```

### Simple Moving Standard Deviation of Return



```{r  eval = TRUE, include=TRUE, warnings=FALSE, fig.show="hold", out.width="50%"}
Portfolio$SMSD_ret_1W <- simple_moving_deviation(Portfolio$Return, 5)
Portfolio$SMSD_ret_2W <- simple_moving_deviation(Portfolio$Return, 10)
Portfolio$SMSD_ret_1M <- simple_moving_deviation(Portfolio$Return, 20)
Portfolio$SMSD_ret_2M <- simple_moving_deviation(Portfolio$Return, 40)


ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMSD_ret_1W, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 1-Week Standard Deviation of Return") +
  scale_y_continuous(limits=c(0, 125), labels = label_comma()) +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMSD_ret_2W, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 2-Week Standard Deviation of Return") +
  scale_y_continuous(limits=c(0, 125), labels = label_comma()) +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMSD_ret_1M, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 1-Month Standard Deviation of Return") +
  scale_y_continuous(limits=c(0, 125), labels = label_comma()) +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMSD_ret_2M, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 2-Month Standard Deviation of Return") +
  scale_y_continuous(limits=c(0, 125), labels = label_comma()) +
  theme_dark()
```
...
```{r  eval = TRUE, include=TRUE, warnings=FALSE, fig.show="hold", out.width="50%"}
Portfolio$SMA_vol_1W <- simple_moving_average(Portfolio$Volume, 5)
Portfolio$SMA_vol_2W <- simple_moving_average(Portfolio$Volume, 10)
Portfolio$SMA_vol_1M <- simple_moving_average(Portfolio$Volume, 20)
Portfolio$SMA_vol_2M <- simple_moving_average(Portfolio$Volume, 40)

ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMA_vol_1W, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 1-Week Average Volume") +
  scale_y_continuous(limits=c(100000000, 350000000), labels = label_comma()) +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMA_vol_2W, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 2-Week Average Volume") +
  scale_y_continuous(limits=c(100000000, 350000000), labels = label_comma()) +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMA_vol_1M, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 1-Month Average Volume") +
  scale_y_continuous(limits=c(100000000, 350000000), labels = label_comma()) +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMA_vol_2M, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 2-Month Average Volume") +
  scale_y_continuous(limits=c(100000000, 350000000), labels = label_comma()) +
  theme_dark()
```


### Simple Moving Standard Deviation of Volume


```{r  eval = TRUE, include=TRUE, warnings=FALSE, fig.show="hold", out.width="50%"}
Portfolio$SMSD_vol_1W <- simple_moving_deviation(Portfolio$Volume, 5)
Portfolio$SMSD_vol_2W <- simple_moving_deviation(Portfolio$Volume, 10)
Portfolio$SMSD_vol_1M <- simple_moving_deviation(Portfolio$Volume, 20)
Portfolio$SMSD_vol_2M <- simple_moving_deviation(Portfolio$Volume, 40)

ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMSD_vol_1W, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 1-Week Standard Deviation of Return") +
  scale_y_continuous(limits=c(0, 120000000), labels = label_comma()) +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMSD_vol_2W, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 2-Week Standard Deviation of Return") +
  scale_y_continuous(limits=c(0, 120000000), labels = label_comma()) +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMSD_vol_1M, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 1-Month Standard Deviation of Return") +
  scale_y_continuous(limits=c(0, 120000000), labels = label_comma()) +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = SMSD_vol_2M, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 2-Month Standard Deviation of Return") +
  scale_y_continuous(limits=c(0, 120000000), labels = label_comma()) +
  theme_dark()
...
```{r eval = TRUE, include=TRUE, warnings=FALSE}
Portfolio_split_1W <- initial_split(Portfolio, prop = 0.7,
                                strata = SMA_cl_1W)
Portfolio_train_1W <- training(Portfolio_split_1W)
Portfolio_test_1W <- testing(Portfolio_split_1W)


Portfolio_split_2W <- initial_split(Portfolio, prop = 0.7,
                                strata = SMA_cl_2W)
Portfolio_train_2W <- training(Portfolio_split_2W)
Portfolio_test_2W <- testing(Portfolio_split_2W)



Portfolio_split_1M <- initial_split(Portfolio, prop = 0.7,
                                strata = SMA_cl_1M)
Portfolio_train_1M <- training(Portfolio_split_1M)
Portfolio_test_1M <- testing(Portfolio_split_1M)



Portfolio_split_2M <- initial_split(Portfolio, prop = 0.7,
                                strata = SMA_cl_2M)
Portfolio_train_2M <- training(Portfolio_split_2M)
Portfolio_test_2M <- testing(Portfolio_split_2M)
```
...
```{r eval = TRUE, include=TRUE, warnings=FALSE}
 Portfolio_recipe_1W = recipe(SMA_cl_1W ~ SMSD_cl_1W +
                                SMA_ret_1W + SMSD_ret_1W +
                                SMA_vol_1W + SMSD_vol_1W,
                     data=Portfolio_train_1W) %>%
  step_center(all_predictors()) %>% 
  step_scale(all_predictors())

 Portfolio_recipe_2W = recipe(SMA_cl_2W ~ SMSD_cl_2W +
                                SMA_ret_2W + SMSD_ret_2W +
                                SMA_vol_2W + SMSD_vol_2W,
                     data=Portfolio_train_2W) %>%
  step_center(all_predictors()) %>% 
  step_scale(all_predictors())

 Portfolio_recipe_1M = recipe(SMA_cl_1M ~ SMSD_cl_1M +
                                SMA_ret_1M + SMSD_ret_1M +
                                SMA_vol_1M + SMSD_vol_1M,
                     data=Portfolio_train_1M) %>%
  step_center(all_predictors()) %>% 
  step_scale(all_predictors())
  
 Portfolio_recipe_2M = recipe(SMA_cl_2M ~ SMSD_cl_2M +
                                SMA_ret_2M + SMSD_ret_2M +
                                SMA_vol_2M + SMSD_vol_2M,
                     data=Portfolio_train_2M) %>%
  step_center(all_predictors()) %>% 
  step_scale(all_predictors())
```
...
```{r eval = TRUE, include=TRUE, warnings=FALSE}
Portfolio_folds_1W <- vfold_cv(Portfolio_train_1W, v = 10, strata = SMA_cl_1W)
Portfolio_folds_2W <- vfold_cv(Portfolio_train_2W, v = 10, strata = SMA_cl_2W)
Portfolio_folds_1M <- vfold_cv(Portfolio_train_1M, v = 10, strata = SMA_cl_1M)
Portfolio_folds_2M <- vfold_cv(Portfolio_train_2M, v = 10, strata = SMA_cl_2M)
```
...
lm_wflow_1W <- workflow() %>% 
  add_model(lm_model) %>% 
  add_recipe(Portfolio_recipe_1W)
lm_wflow_2W <- workflow() %>% 
  add_model(lm_model) %>% 
  add_recipe(Portfolio_recipe_2W)
lm_wflow_1M <- workflow() %>% 
  add_model(lm_model) %>% 
  add_recipe(Portfolio_recipe_1M)
lm_wflow_2M <- workflow() %>% 
  add_model(lm_model) %>% 
  add_recipe(Portfolio_recipe_2M)
...
lm_fit_1W <- fit(lm_wflow_1W, Portfolio_train_1W)
lm_fit_2W <- fit(lm_wflow_2W, Portfolio_train_2W)
lm_fit_1M <- fit(lm_wflow_1M, Portfolio_train_1M)
lm_fit_2M <- fit(lm_wflow_2M, Portfolio_train_2M)

# Ridge Regression Fits
ridge_fit_1W <- fit(ridge_final_wflow_1W, Portfolio_train_1W)
ridge_fit_2W <- fit(ridge_final_wflow_2W, Portfolio_train_2W)
ridge_fit_1M <- fit(ridge_final_wflow_1M, Portfolio_train_1M)
ridge_fit_2M <- fit(ridge_final_wflow_2M, Portfolio_train_2M)

# Lasso Regression Fits
lasso_fit_1W <- fit(lasso_final_wflow_1W, Portfolio_train_1W)
lasso_fit_2W <- fit(lasso_final_wflow_2W, Portfolio_train_2W)
lasso_fit_1M <- fit(lasso_final_wflow_1M, Portfolio_train_1M)
lasso_fit_2M <- fit(lasso_final_wflow_2M, Portfolio_train_2M)

# Elastic Net Fits
elastic_net_fit_1W <- fit(elastic_net_final_wflow_1W, Portfolio_train_1W)
elastic_net_fit_2W <- fit(elastic_net_final_wflow_2W, Portfolio_train_2W)
elastic_net_fit_1M <- fit(elastic_net_final_wflow_1M, Portfolio_train_1M)
elastic_net_fit_2M <- fit(elastic_net_final_wflow_2M, Portfolio_train_2M)

# k-Nearest Neighbors Fit
knn_fit_1W <- fit(knn_final_wflow_1W, Portfolio_train_1W)
knn_fit_2W <- fit(knn_final_wflow_2W, Portfolio_train_2W)
knn_fit_1M <- fit(knn_final_wflow_1M, Portfolio_train_1M)
knn_fit_2M <- fit(knn_final_wflow_2M, Portfolio_train_2M)
```
...
lm_train_res_1W <- predict(lm_fit_1W, new_data = Portfolio_train_1W %>% select(-SMA_cl_1W))
lm_train_res_1W <- bind_cols(lm_train_res_1W, Portfolio_train_1W %>% select(SMA_cl_1W))

lm_train_res_2W <- predict(lm_fit_2W, new_data = Portfolio_train_2W %>% select(-SMA_cl_2W))
lm_train_res_2W <- bind_cols(lm_train_res_2W, Portfolio_train_2W %>% select(SMA_cl_2W))

lm_train_res_1M <- predict(lm_fit_1M, new_data = Portfolio_train_1M %>% select(-SMA_cl_1M))
lm_train_res_1M <- bind_cols(lm_train_res_1M, Portfolio_train_1M %>% select(SMA_cl_1M))

lm_train_res_2M <- predict(lm_fit_2M, new_data = Portfolio_train_2M %>% select(-SMA_cl_2M))
lm_train_res_2M <- bind_cols(lm_train_res_2M, Portfolio_train_2M %>% select(SMA_cl_2M))


# Ridge Regression Training
ridge_train_res_1W <- predict(ridge_fit_1W, new_data = Portfolio_train_1W %>% select(-SMA_cl_1W))
ridge_train_res_1W <- bind_cols(ridge_train_res_1W, Portfolio_train_1W %>% select(SMA_cl_1W))

ridge_train_res_2W <- predict(ridge_fit_2W, new_data = Portfolio_train_2W %>% select(-SMA_cl_2W))
ridge_train_res_2W <- bind_cols(ridge_train_res_2W, Portfolio_train_2W %>% select(SMA_cl_2W))

ridge_train_res_1M <- predict(ridge_fit_1M, new_data = Portfolio_train_1M %>% select(-SMA_cl_1M))
ridge_train_res_1M <- bind_cols(ridge_train_res_1M, Portfolio_train_1M %>% select(SMA_cl_1M))

ridge_train_res_2M <- predict(ridge_fit_2M, new_data = Portfolio_train_2M %>% select(-SMA_cl_2M))
ridge_train_res_2M <- bind_cols(ridge_train_res_2M, Portfolio_train_2M %>% select(SMA_cl_2M))


# Lasso Regression Training
lasso_train_res_1W <- predict(lasso_fit_1W, new_data = Portfolio_train_1W %>% select(-SMA_cl_1W))
lasso_train_res_1W <- bind_cols(lasso_train_res_1W, Portfolio_train_1W %>% select(SMA_cl_1W))

lasso_train_res_2W <- predict(lasso_fit_2W, new_data = Portfolio_train_2W %>% select(-SMA_cl_2W))
lasso_train_res_2W <- bind_cols(lasso_train_res_2W, Portfolio_train_2W %>% select(SMA_cl_2W))

lasso_train_res_1M <- predict(lasso_fit_1M, new_data = Portfolio_train_1M %>% select(-SMA_cl_1M))
lasso_train_res_1M <- bind_cols(lasso_train_res_1M, Portfolio_train_1M %>% select(SMA_cl_1M))

lasso_train_res_2M <- predict(lasso_fit_2M, new_data = Portfolio_train_2M %>% select(-SMA_cl_2M))
lasso_train_res_2M <- bind_cols(lasso_train_res_2M, Portfolio_train_2M %>% select(SMA_cl_2M))

# Elastic Net Training
elastic_net_train_res_1W <- predict(elastic_net_fit_1W, new_data = Portfolio_train_1W %>% select(-SMA_cl_1W))
elastic_net_train_res_1W <- bind_cols(elastic_net_train_res_1W, Portfolio_train_1W %>% select(SMA_cl_1W))

elastic_net_train_res_2W <- predict(elastic_net_fit_2W, new_data = Portfolio_train_2W %>% select(-SMA_cl_2W))
elastic_net_train_res_2W <- bind_cols(elastic_net_train_res_2W, Portfolio_train_2W %>% select(SMA_cl_2W))

elastic_net_train_res_1M <- predict(elastic_net_fit_1M, new_data = Portfolio_train_1M %>% select(-SMA_cl_1M))
elastic_net_train_res_1M <- bind_cols(elastic_net_train_res_1M, Portfolio_train_1M %>% select(SMA_cl_1M))

elastic_net_train_res_2M <- predict(elastic_net_fit_2M, new_data = Portfolio_train_2M %>% select(-SMA_cl_2M))
elastic_net_train_res_2M <- bind_cols(elastic_net_train_res_2M, Portfolio_train_2M %>% select(SMA_cl_2M))

# k-Nearest Neighbors Training
knn_train_res_1W <- predict(knn_fit_1W, new_data = Portfolio_train_1W %>% select(-SMA_cl_1W))
knn_train_res_1W <- bind_cols(knn_train_res_1W, Portfolio_train_1W %>% select(SMA_cl_1W))

knn_train_res_2W <- predict(knn_fit_2W, new_data = Portfolio_train_2W %>% select(-SMA_cl_2W))
knn_train_res_2W <- bind_cols(knn_train_res_2W, Portfolio_train_2W %>% select(SMA_cl_2W))

knn_train_res_1M <- predict(knn_fit_1M, new_data = Portfolio_train_1M %>% select(-SMA_cl_1M))
knn_train_res_1M <- bind_cols(knn_train_res_1M, Portfolio_train_1M %>% select(SMA_cl_1M))

knn_train_res_2M <- predict(knn_fit_2M, new_data = Portfolio_train_2M %>% select(-SMA_cl_2M))
knn_train_res_2M <- bind_cols(knn_train_res_2M, Portfolio_train_2M %>% select(SMA_cl_2M))
```
...
tibble(Model = c("Linear Regression", "Ridge Regression", "Lasso Regression", "Elastic Net", "k-Nearest Neighbors"),
       One_Week = c((lm_train_res_1W %>% rmse( SMA_cl_1W, .pred))$.estimate,
                    (ridge_train_res_1W %>% rmse( SMA_cl_1W, .pred))$.estimate,
                    (lasso_train_res_1W %>% rmse( SMA_cl_1W, .pred))$.estimate,
                    (elastic_net_train_res_1W %>% rmse( SMA_cl_1W, .pred))$.estimate,
                    (knn_train_res_1W %>% rmse( SMA_cl_1W, .pred))$.estimate ),
       Two_Week = c((lm_train_res_2W %>% rmse( SMA_cl_2W, .pred))$.estimate,
                    (ridge_train_res_2W %>% rmse( SMA_cl_2W, .pred))$.estimate,
                    (lasso_train_res_2W %>% rmse( SMA_cl_2W, .pred))$.estimate,
                    (elastic_net_train_res_2W %>% rmse( SMA_cl_2W, .pred))$.estimate,
                    (knn_train_res_2W %>% rmse( SMA_cl_2W, .pred))$.estimate),
       One_Month = c((lm_train_res_1M %>% rmse( SMA_cl_1M, .pred))$.estimate,
                    (ridge_train_res_1M %>% rmse( SMA_cl_1M, .pred))$.estimate,
                    (lasso_train_res_1M %>% rmse( SMA_cl_1M, .pred))$.estimate,
                    (elastic_net_train_res_1M %>% rmse( SMA_cl_1M, .pred))$.estimate,
                    (knn_train_res_1M %>% rmse( SMA_cl_1M, .pred))$.estimate),
       Two_Month = c((lm_train_res_2M %>% rmse( SMA_cl_2M, .pred))$.estimate,
                    (ridge_train_res_2M %>% rmse( SMA_cl_2M, .pred))$.estimate,
                    (lasso_train_res_2M %>% rmse( SMA_cl_2M, .pred))$.estimate,
                    (elastic_net_train_res_2M %>% rmse( SMA_cl_2M, .pred))$.estimate,
                    (knn_train_res_2M %>% rmse( SMA_cl_2M, .pred))$.estimate)
       )
```
...
tibble(Model = c("Linear Regression", "Ridge Regression", "Lasso Regression", "Elastic Net", "k-Nearest Neighbors"),
       One_Week = c((lm_train_res_1W %>% rsq( SMA_cl_1W, .pred))$.estimate,
                    (ridge_train_res_1W %>% rsq( SMA_cl_1W, .pred))$.estimate,
                    (lasso_train_res_1W %>% rsq( SMA_cl_1W, .pred))$.estimate,
                    (elastic_net_train_res_1W %>% rsq( SMA_cl_1W, .pred))$.estimate,
                    (knn_train_res_1W %>% rsq( SMA_cl_1W, .pred))$.estimate ),
       Two_Week = c((lm_train_res_2W %>% rsq( SMA_cl_2W, .pred))$.estimate,
                    (ridge_train_res_2W %>% rsq( SMA_cl_2W, .pred))$.estimate,
                    (lasso_train_res_2W %>% rsq( SMA_cl_2W, .pred))$.estimate,
                    (elastic_net_train_res_2W %>% rsq( SMA_cl_2W, .pred))$.estimate,
                    (knn_train_res_2W %>% rsq( SMA_cl_2W, .pred))$.estimate),
       One_Month = c((lm_train_res_1M %>% rsq( SMA_cl_1M, .pred))$.estimate,
                    (ridge_train_res_1M %>% rsq( SMA_cl_1M, .pred))$.estimate,
                    (lasso_train_res_1M %>% rsq( SMA_cl_1M, .pred))$.estimate,
                    (elastic_net_train_res_1M %>% rsq( SMA_cl_1M, .pred))$.estimate,
                    (knn_train_res_1M %>% rsq( SMA_cl_1M, .pred))$.estimate),
       Two_Month = c((lm_train_res_2M %>% rsq( SMA_cl_2M, .pred))$.estimate,
                    (ridge_train_res_2M %>% rsq( SMA_cl_2M, .pred))$.estimate,
                    (lasso_train_res_2M %>% rsq( SMA_cl_2M, .pred))$.estimate,
                    (elastic_net_train_res_2M %>% rsq( SMA_cl_2M, .pred))$.estimate,
                    (knn_train_res_2M %>% rsq( SMA_cl_2M, .pred))$.estimate)
       )
```