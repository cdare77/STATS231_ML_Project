...
# Define Model for Random Forest
############################
random_forest_grid <- grid_regular(mtry(range = c(2, 8)),
...
# Define Model for Boosted Trees
############################
boosted_trees_grid <- grid_regular(mtry(range = c(2, 8)), 
...
```{r eval = FALSE, include=TRUE, warnings=FALSE}
############################
...
Model Performance of Hyperparameter Tuning:
...
autoplot(ridge_tune_AMD) + theme_dark()
autoplot(ridge_tune_NVDA) + theme_dark()
```
```{r eval = TRUE, include=TRUE, warnings=FALSE, fig.show="hold", out.width="50%"}
...
autoplot(lasso_tune_AMD) + theme_dark()
autoplot(lasso_tune_NVDA) + theme_dark()
```
...
autoplot(elastic_net_tune_AMD) + theme_dark()
autoplot(elastic_net_tune_NVDA) + theme_dark()
```
...
autoplot(knn_tune_AMD) + theme_dark()
autoplot(knn_tune_NVDA) + theme_dark()
```
```{r eval = TRUE, include=TRUE, warnings=FALSE, fig.show="hold", out.width="50%"}
...
autoplot(random_forest_tune_AMD) + theme_dark() + theme(text = element_text(size = 9))
autoplot(random_forest_tune_NVDA) + theme_dark() + theme(text = element_text(size = 9))
```
```{r eval = TRUE, include=TRUE, warnings=FALSE, fig.show="hold", out.width="50%"}
...
autoplot(boosted_trees_tune_AMD) + theme_dark() + theme(text = element_text(size = 9))
autoplot(boosted_trees_tune_NVDA) + theme_dark() + theme(text = element_text(size = 9))
```
