...
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = avg_cl_1W, color = 'red')) +
  ylab('USD') + 
...
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = avg_cl_1M, color = 'red')) +
  ylab('USD') + 
...
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = avg_cl_2M, color = 'red')) +
  ylab('USD') + 
...
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = std_dev_cl_1W, color = 'red')) +
  ylab('USD') + 
...
ggplot(data = Portfolio, aes(x=Date)) +
  ...
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = std_dev_cl_1M, color = 'red')) +
  ylab('USD') + 
  scale_y_continuous(limits=c(0, 520), labels = label_comma()) +
  ggtitle("Portfolio: 1-Month Standard Deviation of Closing Price") +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = std_dev_cl_2M, color = 'red')) +
  ylab('USD') + 
  scale_y_continuous(limits=c(0, 520), labels = label_comma()) +
...
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = avg_ret_1W, color = 'red')) +
  ylab('USD') + 
...
ggplot(data = Portfolio, aes(x=Date)) +
  ...
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = avg_ret_1M, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 1-Month Average Return") +
  scale_y_continuous(limits=c(-80, 80), labels = label_comma()) +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = avg_ret_2M, color = 'red')) +
  ylab('USD') + 
...
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = std_dev_ret_1W, color = 'red')) +
  ylab('USD') + 
...
ggplot(data = Portfolio, aes(x=Date)) +
  ...
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = std_dev_ret_1M, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 1-Month Standard Deviation of Return") +
  scale_y_continuous(limits=c(0, 125), labels = label_comma()) +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = std_dev_ret_2M, color = 'red')) +
  ylab('USD') + 
...
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = avg_vol_1W, color = 'red')) +
  ylab('USD') + 
...
ggplot(data = Portfolio, aes(x=Date)) +
  ...
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = avg_vol_1M, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 1-Month Average Volume") +
  scale_y_continuous(limits=c(100000000, 350000000), labels = label_comma()) +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = avg_vol_2M, color = 'red')) +
  ylab('USD') + 
...
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = std_dev_vol_1W, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 1-Week Standard Deviation of Return") +
...
ggplot(data = Portfolio, aes(x=Date)) +
  ...
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = std_dev_vol_1M, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 1-Month Standard Deviation of Return") +
  scale_y_continuous(limits=c(0, 120000000), labels = label_comma()) +
  theme_dark()
ggplot(data = Portfolio, aes(x=Date)) +
  geom_line(aes(y = std_dev_vol_2M, color = 'red')) +
  ylab('USD') + 
  ggtitle("Portfolio: 2-Month Standard Deviation of Return") +
  scale_y_continuous(limits=c(0, 120000000), labels = label_comma()) +
  theme_dark()
...
```{r eval = TRUE, include=TRUE, warnings=FALSE}
 Portfolio_recipe_1W = recipe(avg_cl_1W ~ std_dev_cl_1W +
                                avg_ret_1W + std_dev_ret_1W +
                                avg_vol_1W + std_dev_vol_1W,
                     data=Portfolio_train_1W) %>%
  step_center(all_predictors()) %>% 
  step_scale(all_predictors())

 Portfolio_recipe_2W = recipe(avg_cl_2W ~ std_dev_cl_2W +
                                avg_ret_2W + std_dev_ret_2W +
                                avg_vol_2W + std_dev_vol_2W,
                     data=Portfolio_train_2W) %>%
  step_center(all_predictors()) %>% 
  step_scale(all_predictors())

 Portfolio_recipe_1M = recipe(avg_cl_1M ~ std_dev_cl_1M +
                                avg_ret_1M + std_dev_ret_1M +
                                avg_vol_1M + std_dev_vol_1M,
                     data=Portfolio_train_1M) %>%
  step_center(all_predictors()) %>% 
  step_scale(all_predictors())
  
 Portfolio_recipe_2M = recipe(avg_cl_2M ~ std_dev_cl_2M +
                                avg_ret_2M + std_dev_ret_2M +
                                avg_vol_2M + std_dev_vol_2M,
...
```{r eval = TRUE, include=TRUE, warnings=FALSE}
Portfolio_folds_1W <- vfold_cv(Portfolio_train_1W, v = 10, strata = avg_cl_1W)
Portfolio_folds_2W <- vfold_cv(Portfolio_train_2W, v = 10, strata = avg_cl_2W)
Portfolio_folds_1M <- vfold_cv(Portfolio_train_1M, v = 10, strata = avg_cl_1M)
Portfolio_folds_2M <- vfold_cv(Portfolio_train_2M, v = 10, strata = avg_cl_2M)
```
...
lm_train_res_1W <- predict(lm_fit_1W, new_data = Portfolio_train_1W %>% select(-avg_cl_1W))
lm_train_res_1W <- bind_cols(lm_train_res_1W, Portfolio_train_1W %>% select(avg_cl_1W))

lm_train_res_2W <- predict(lm_fit_2W, new_data = Portfolio_train_2W %>% select(-avg_cl_2W))
lm_train_res_2W <- bind_cols(lm_train_res_2W, Portfolio_train_2W %>% select(avg_cl_2W))

lm_train_res_1M <- predict(lm_fit_1M, new_data = Portfolio_train_1M %>% select(-avg_cl_1M))
lm_train_res_1M <- bind_cols(lm_train_res_1M, Portfolio_train_1M %>% select(avg_cl_1M))

lm_train_res_2M <- predict(lm_fit_2M, new_data = Portfolio_train_2M %>% select(-avg_cl_2M))
lm_train_res_2M <- bind_cols(lm_train_res_2M, Portfolio_train_2M %>% select(avg_cl_2M))


# Ridge Regression Training
ridge_train_res_1W <- predict(ridge_fit_1W, new_data = Portfolio_train_1W %>% select(-avg_cl_1W))
ridge_train_res_1W <- bind_cols(ridge_train_res_1W, Portfolio_train_1W %>% select(avg_cl_1W))

ridge_train_res_2W <- predict(ridge_fit_2W, new_data = Portfolio_train_2W %>% select(-avg_cl_2W))
ridge_train_res_2W <- bind_cols(ridge_train_res_2W, Portfolio_train_2W %>% select(avg_cl_2W))

ridge_train_res_1M <- predict(ridge_fit_1M, new_data = Portfolio_train_1M %>% select(-avg_cl_1M))
ridge_train_res_1M <- bind_cols(ridge_train_res_1M, Portfolio_train_1M %>% select(avg_cl_1M))

ridge_train_res_2M <- predict(ridge_fit_2M, new_data = Portfolio_train_2M %>% select(-avg_cl_2M))
ridge_train_res_2M <- bind_cols(ridge_train_res_2M, Portfolio_train_2M %>% select(avg_cl_2M))


# Lasso Regression Training
lasso_train_res_1W <- predict(lasso_fit_1W, new_data = Portfolio_train_1W %>% select(-avg_cl_1W))
lasso_train_res_1W <- bind_cols(lasso_train_res_1W, Portfolio_train_1W %>% select(avg_cl_1W))

lasso_train_res_2W <- predict(lasso_fit_2W, new_data = Portfolio_train_2W %>% select(-avg_cl_2W))
lasso_train_res_2W <- bind_cols(lasso_train_res_2W, Portfolio_train_2W %>% select(avg_cl_2W))

lasso_train_res_1M <- predict(lasso_fit_1M, new_data = Portfolio_train_1M %>% select(-avg_cl_1M))
lasso_train_res_1M <- bind_cols(lasso_train_res_1M, Portfolio_train_1M %>% select(avg_cl_1M))

lasso_train_res_2M <- predict(lasso_fit_2M, new_data = Portfolio_train_2M %>% select(-avg_cl_2M))
lasso_train_res_2M <- bind_cols(lasso_train_res_2M, Portfolio_train_2M %>% select(avg_cl_2M))

# Elastic Net Training
elastic_net_train_res_1W <- predict(elastic_net_fit_1W, new_data = Portfolio_train_1W %>% select(-avg_cl_1W))
elastic_net_train_res_1W <- bind_cols(elastic_net_train_res_1W, Portfolio_train_1W %>% select(avg_cl_1W))

elastic_net_train_res_2W <- predict(elastic_net_fit_2W, new_data = Portfolio_train_2W %>% select(-avg_cl_2W))
elastic_net_train_res_2W <- bind_cols(elastic_net_train_res_2W, Portfolio_train_2W %>% select(avg_cl_2W))

elastic_net_train_res_1M <- predict(elastic_net_fit_1M, new_data = Portfolio_train_1M %>% select(-avg_cl_1M))
elastic_net_train_res_1M <- bind_cols(elastic_net_train_res_1M, Portfolio_train_1M %>% select(avg_cl_1M))

elastic_net_train_res_2M <- predict(elastic_net_fit_2M, new_data = Portfolio_train_2M %>% select(-avg_cl_2M))
elastic_net_train_res_2M <- bind_cols(elastic_net_train_res_2M, Portfolio_train_2M %>% select(avg_cl_2M))

# k-Nearest Neighbors Training
knn_train_res_1W <- predict(knn_fit_1W, new_data = Portfolio_train_1W %>% select(-avg_cl_1W))
knn_train_res_1W <- bind_cols(knn_train_res_1W, Portfolio_train_1W %>% select(avg_cl_1W))

knn_train_res_2W <- predict(knn_fit_2W, new_data = Portfolio_train_2W %>% select(-avg_cl_2W))
knn_train_res_2W <- bind_cols(knn_train_res_2W, Portfolio_train_2W %>% select(avg_cl_2W))

knn_train_res_1M <- predict(knn_fit_1M, new_data = Portfolio_train_1M %>% select(-avg_cl_1M))
knn_train_res_1M <- bind_cols(knn_train_res_1M, Portfolio_train_1M %>% select(avg_cl_1M))

knn_train_res_2M <- predict(knn_fit_2M, new_data = Portfolio_train_2M %>% select(-avg_cl_2M))
knn_train_res_2M <- bind_cols(knn_train_res_2M, Portfolio_train_2M %>% select(avg_cl_2M))
```
...
tibble(Model = c("Linear Regression", "Ridge Regression", "Lasso Regression", "Elastic Net", "k-Nearest Neighbors"),
       One_Week = c((lm_train_res_1W %>% rmse( avg_cl_1W, .pred))$.estimate,
                    (ridge_train_res_1W %>% rmse( avg_cl_1W, .pred))$.estimate,
                    (lasso_train_res_1W %>% rmse( avg_cl_1W, .pred))$.estimate,
                    (elastic_net_train_res_1W %>% rmse( avg_cl_1W, .pred))$.estimate,
                    (knn_train_res_1W %>% rmse( avg_cl_1W, .pred))$.estimate ),
       Two_Week = c((lm_train_res_2W %>% rmse( avg_cl_2W, .pred))$.estimate,
                    (ridge_train_res_2W %>% rmse( avg_cl_2W, .pred))$.estimate,
                    (lasso_train_res_2W %>% rmse( avg_cl_2W, .pred))$.estimate,
                    (elastic_net_train_res_2W %>% rmse( avg_cl_2W, .pred))$.estimate,
                    (knn_train_res_2W %>% rmse( avg_cl_2W, .pred))$.estimate),
       One_Month = c((lm_train_res_1M %>% rmse( avg_cl_1M, .pred))$.estimate,
                    (ridge_train_res_1M %>% rmse( avg_cl_1M, .pred))$.estimate,
                    (lasso_train_res_1M %>% rmse( avg_cl_1M, .pred))$.estimate,
                    (elastic_net_train_res_1M %>% rmse( avg_cl_1M, .pred))$.estimate,
                    (knn_train_res_1M %>% rmse( avg_cl_1M, .pred))$.estimate),
       Two_Month = c((lm_train_res_2M %>% rmse( avg_cl_2M, .pred))$.estimate,
                    (ridge_train_res_2M %>% rmse( avg_cl_2M, .pred))$.estimate,
                    (lasso_train_res_2M %>% rmse( avg_cl_2M, .pred))$.estimate,
                    (elastic_net_train_res_2M %>% rmse( avg_cl_2M, .pred))$.estimate,
                    (knn_train_res_2M %>% rmse( avg_cl_2M, .pred))$.estimate)
       )
```
...
tibble(Model = c("Linear Regression", "Ridge Regression", "Lasso Regression", "Elastic Net", "k-Nearest Neighbors"),
       One_Week = c((lm_train_res_1W %>% rsq( avg_cl_1W, .pred))$.estimate,
                    (ridge_train_res_1W %>% rsq( avg_cl_1W, .pred))$.estimate,
                    (lasso_train_res_1W %>% rsq( avg_cl_1W, .pred))$.estimate,
                    (elastic_net_train_res_1W %>% rsq( avg_cl_1W, .pred))$.estimate,
                    (knn_train_res_1W %>% rsq( avg_cl_1W, .pred))$.estimate ),
       Two_Week = c((lm_train_res_2W %>% rsq( avg_cl_2W, .pred))$.estimate,
                    (ridge_train_res_2W %>% rsq( avg_cl_2W, .pred))$.estimate,
                    (lasso_train_res_2W %>% rsq( avg_cl_2W, .pred))$.estimate,
                    (elastic_net_train_res_2W %>% rsq( avg_cl_2W, .pred))$.estimate,
                    (knn_train_res_2W %>% rsq( avg_cl_2W, .pred))$.estimate),
       One_Month = c((lm_train_res_1M %>% rsq( avg_cl_1M, .pred))$.estimate,
                    (ridge_train_res_1M %>% rsq( avg_cl_1M, .pred))$.estimate,
                    (lasso_train_res_1M %>% rsq( avg_cl_1M, .pred))$.estimate,
                    (elastic_net_train_res_1M %>% rsq( avg_cl_1M, .pred))$.estimate,
                    (knn_train_res_1M %>% rsq( avg_cl_1M, .pred))$.estimate),
       Two_Month = c((lm_train_res_2M %>% rsq( avg_cl_2M, .pred))$.estimate,
                    (ridge_train_res_2M %>% rsq( avg_cl_2M, .pred))$.estimate,
                    (lasso_train_res_2M %>% rsq( avg_cl_2M, .pred))$.estimate,
                    (elastic_net_train_res_2M %>% rsq( avg_cl_2M, .pred))$.estimate,
                    (knn_train_res_2M %>% rsq( avg_cl_2M, .pred))$.estimate)
       )
```